...
public class Barrier extends JFrame implements Observer, ActionListener
{
	...
	if (e.getSource().equals(enterButton))
	{
	    ...
	    if(lnkVehicle_list.containsKey(regText)) {
	    	
	    //TODO the positive case	
	    	...
	    	JOptionPane.showMessageDialog(null, "this registration plate is not in the list, access is denied", "Warning", JOptionPane.WARNING_MESSAGE);
	        label.setText("STOP");
	        label.setForeground(Color.red);
	    	
	    	}
	    	else {
	    		JOptionPane.showMessageDialog(null, "the system is deactivated", "information", JOptionPane.INFORMATION_MESSAGE);
	    		label.setText("PASS");
		        label.setForeground(Color.green);
