...
public class Barrier extends JFrame implements Observer, ActionListener
{
	...
	if (e.getSource().equals(enterButton))
	{
	    ...
	    {
		JOptionPane.showMessageDialog(null, "The vehicle can pass", "Information",
		...
		{
		    JOptionPane.showMessageDialog(null, "this registration plate is not in the list, access is denied",
		...
		{
		    JOptionPane.showMessageDialog(null, "the system is deactivated", "information",
			    JOptionPane.INFORMATION_MESSAGE);
		    label.setText("PASS");
		    label.setForeground(Color.green);
		}
