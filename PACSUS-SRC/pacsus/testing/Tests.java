...
class Tests {
	...
	/**
	 * This test makes sure that we can successfully update the permit of a permit holder.
	 * 
	 */
	@Test
	void updateTest() {
	...
	/**
	 * This test check if deltePermit() successfully deletes a permit from Permit_list.
	 * 
	 */
	@Test
	...
	/**
	 * This test check if getPermitsByType() returns a ArrayList of a certain type of permits.
	 */
	@Test
