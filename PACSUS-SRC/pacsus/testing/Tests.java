...
class Tests
{
    ...
    /**
     * This test check if resetWarning resets the count of warnings back to 0 This
     * method is called when a yearReset is called which makes everything reset.
     */
    @Test
    ...
    /**
     * This test is important because is crucial to make sure that we can
     * successfully update the permit of a permit holder.
     * 
     */
    @Test
    void updateTest()
